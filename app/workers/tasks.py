...
from app.models.datasource import DataSource, DataSourceRow, DataSourceStatus
from app.models.job import Job, JobItem, JobStatus, JobItemStatus, GenerationMode
from app.models.output import Output, OutputType
from app.services.storage import download_from_s3, upload_to_s3
from app.services.file_parser import parse_file
from app.services.template_engine import render_template, apply_mapping
...
def render_document(
    ...
    try:
        ...
        if output_format == "pdf":
            from app.workers.pdf_generator import generate_pdf
