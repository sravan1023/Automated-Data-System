...
from server.models.datasource import DataSource, DataSourceStatus, FileType
from server.schemas.datasource import (
    DataSourceResponse,
    DataSourceDetailResponse,
    DataSourceUpdate,
)
from server.services.file_parser import parse_file, infer_schema
from server.services.storage import upload_to_s3
...
async def upload_datasource(
    ...
    """
    from server.models.datasource import DataSourceRow
