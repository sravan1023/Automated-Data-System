...
async def create_job(
    ...
    from server.models.template import Template, TemplateVersion
    result = await db.execute(
    ...
    from server.models.datasource import DataSource, DataSourceStatus
    result = await db.execute(
    ...
    from server.workers.tasks import process_job
